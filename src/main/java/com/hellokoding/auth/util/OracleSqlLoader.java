...
//        final List<String> columnNames = getTableColumns(conn, tableName);
        ...
        columnNames.add("TIPDOC");
        columnNames.add("CODDOC");
        columnNames.add("FLG_DIRECCION");
        columnNames.add("FLG_EMAIL");
        columnNames.add("FLG_TELEFONO");
        columnNames.add("USU_SOLICITUD");
        columnNames.add("ID_SOLICITUD");
   ...
   /* public static void main(String... args) throws Exception {
        ...
        final String instance = System.getProperty("TLBDFORACLE.pe.igrupobbva");
        final String username = System.getProperty("PAGCOM");
        final String password = System.getProperty("badbOEpLOxhO");
